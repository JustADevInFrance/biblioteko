...
def main(global_config, **settings):
    ...
    config.add_route('demande_role', '/demande-role')

    config.add_route('admin_demandes', '/admin/demandes')

    config.add_route('admin_accepter', '/admin/accepter/{id}')
    config.add_route('admin_refuser', '/admin/refuser/{id}')
